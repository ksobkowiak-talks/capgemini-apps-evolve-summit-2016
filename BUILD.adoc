...
. Clone this repository with pre-configured submodules
  ...
  $ git clone --recursive git@github.com:sobkowiak/capgemini-apps-evolve-summit-2016.git

You can clone the dependencies separately

. Clone this repository

  $ git clone git@github.com:sobkowiak/capgemini-apps-evolve-summit-2016.git
